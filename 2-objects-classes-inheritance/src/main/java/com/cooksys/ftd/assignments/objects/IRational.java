...
interface IRational {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		...
		int newNum =  ((this.getNumerator() * that.getDenominator()) + (that.getNumerator()*this.getDenominator()));
		int newDen = (this.getDenominator()*that.getDenominator());
	...
	default IRational mul(IRational that) throws IllegalArgumentException {
		...
		int newNum = this.getNumerator()*that.getNumerator();
		int newDen = this.getDenominator()*that.getDenominator();
		return construct(newNum, newDen);
	}
	...
	default IRational div(IRational that) throws IllegalArgumentException {
		...
		int newNum = this.getNumerator()*that.getDenominator();
		int newDen = this.getDenominator()*that.getNumerator();
		return construct(newNum, newDen);
	}
}
